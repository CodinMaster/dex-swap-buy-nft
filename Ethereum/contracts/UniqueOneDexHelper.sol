...
contract UniqueOneDexHelper is IERC721Receiver {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    
    IERC721Sale erc721Sale;
    
    constructor(IERC721Sale _erc721Sale) public {
    ...
    function buyNFT(
        ...
        // buy NFT
        erc721Sale.buy.value(price.add(buyerFeeValue))(
            token,
            tokenId,
            price,
            sellerFee,
